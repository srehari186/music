...
export function AudioPlayer() {
  ...
  return (
    <>
      ...
      <div className="fixed inset-x-2 bottom-[calc(4.25rem+env(safe-area-inset-bottom))] z-30 overflow-hidden rounded-2xl border border-line bg-abyss/70 shadow-card backdrop-blur-xl backdrop-saturate-150 lg:inset-x-0 lg:bottom-0 lg:rounded-none lg:border-x-0 lg:border-b-0 lg:border-t lg:shadow-none lg:pb-[env(safe-area-inset-bottom)]">
